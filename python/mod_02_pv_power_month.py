...
class PVMonthCalculator:
    ...
    def __init__(self, params_file, sheet_name='panel_pars', solar_energy_type='pv'):
        ...
        self.rayon = self.params_df.loc['name', 'pv']  # District name
        ...
        self.rtd = Rooftops_Data(rayon=self.rayon, show=True)
    ...
    def calculate(self):
        ...
        Roofs_pv.to_excel(self.rtd.res_file_month,
                          ...
                          sheet_name=self.rayon.capitalize())
        print(f'\nResult saved to file `{self.rtd.res_file_month}`')


# Example usage:
# calculator = PVMonthCalculator('path_to_your_file.xlsx')
